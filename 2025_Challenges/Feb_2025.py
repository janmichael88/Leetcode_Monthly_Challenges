...
class Solution:
    def shortestCommonSupersequence(self, str1: str, str2: str) -> str:
        '''
        recall dp lcs,
        let dp(i,j) be the the lcs using str1[i:] and str2[j:]
        if they match we add 1 to dp(i+1,j+1)
        otherwise we take max of dp(i+1,j) or dp(i,j+1)
        '''
        memo = {}
        def dp(str1,str2):
            ...
            if str1[0] == str2[0]:
                memo[(str1,str2)] = str1[0] + dp(str1[1:],str2[1:])
                return memo[(str1,str2)]

            #other chose from either/or
            first = str1[0] + dp(str1[1:],str2)
            second = str2[0] + dp(str1, str2[1:])
...
#bottom up is still cache on strings though
class Solution:
    def shortestCommonSupersequence(self, str1: str, str2: str) -> str:
